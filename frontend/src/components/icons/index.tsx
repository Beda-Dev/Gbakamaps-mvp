...
// Icône "choisir sur la carte" (bouton de sélection par clic dans le
// planificateur), copiée depuis https://lucide.dev/icons/crosshair, même
// licence ISC (voir LICENSES-ICONS.md).
...
// Icône "calques" (sélecteur de style de carte compact sur mobile, §12.24),
// copiée depuis https://lucide.dev/icons/layers, même licence ISC.
